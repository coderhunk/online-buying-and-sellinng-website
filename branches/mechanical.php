    ...
    <div class="content">
    	<div class="content_top">
	      ...
	      <div class="section group">
			  ...
			  $books=mysqli_query($con,"SELECT * FROM products WHERE branchcat='MECHANICAL' && procat='Books' && visibility='1' ORDER BY sno DESC LIMIT 12");
			  ...
			  {
			  while($booksd=mysqli_fetch_array($books))
			  {
				  ?>
		...
		<div class="content_top">
	      ...
	      <div class="section group">
			  ...
			  $gadget=mysqli_query($con,"SELECT * FROM products WHERE branchcat='MECHANICAL' && procat='Gadgets' && visibility='1' ORDER BY sno DESC LIMIT 12");
			  if(mysqli_num_rows($gadget)<1)
			  {
			  ...
			  {
			  while($gadgetd['sno']=mysqli_fetch_array($gadget))
			  {
				  ?>
				<div class="grid_1_of_4 images_1_of_4">
		...
		<div class="content_top">
	      ...
	      <div class="section group">
			  ...
			  $arts=mysqli_query($con,"SELECT * FROM products WHERE branchcat='MECHANICAL' && procat='Arts' && visibility='1' ORDER BY sno DESC LIMIT 12");
			  if(mysqli_num_rows($arts)<1)
			  {
			  ...
			  {
			  while($artsd=mysqli_fetch_array($arts))
			  {
				  ?>
				<div class="grid_1_of_4 images_1_of_4">
		...
		<div class="content_top">
	      ...
	      <div class="section group">
			  ...
			  $others=mysqli_query($con,"SELECT * FROM products WHERE branchcat='MECHANICAL' && procat='Others' && visibility='1' ORDER BY sno DESC LIMIT 12");
			  if(mysqli_num_rows($others)<1)
			  {
				  echo "<center><h3>There are nothing in the cart in this category</h3></center>";
			  }
			  else
			  {
			  while($othersd=mysqli_fetch_array($others))
			  {
				  ?>
				<div class="grid_1_of_4 images_1_of_4">
