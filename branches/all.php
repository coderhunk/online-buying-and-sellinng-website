    ...
    <div class="content">
    	<div class="content_top">
	      ...
	      <div class="section group">
			  ...
			  $books=mysqli_query($con,"SELECT * FROM products WHERE visibility='1' && procat='Books' && branchcat='ALL' ORDER BY sno DESC LIMIT 12");
		...
		<div class="content_top">
	      ...
	      <div class="section group">
			  ...
			  $gadget=mysqli_query($con,"SELECT * FROM products WHERE visibility='1' && procat='Gadgets'  && branchcat='ALL' ORDER BY sno DESC LIMIT 12");
		...
		<div class="content_top">
	      ...
	      <div class="section group">
			  ...
			  $arts=mysqli_query($con,"SELECT * FROM products WHERE visibility='1' && procat='Arts'  && branchcat='ALL' ORDER BY sno DESC LIMIT 12");
		...
		<div class="content_top">
	      ...
	      <div class="section group">
			  ...
			  $others=mysqli_query($con,"SELECT * FROM products WHERE visibility='1' && procat='Others'  && branchcat='ALL' ORDER BY sno DESC LIMIT 12");
