    ...
    <div class="content">
    	<div class="content_top">
	      ...
	      <div class="section group">
			  ...
			  $books=mysqli_query($con,"SELECT * FROM products WHERE branchcat='CHEMICAL' && procat='Books' && visibility='1' ORDER BY sno DESC LIMIT 12");
		...
		<div class="content_top">
	      ...
	      <div class="section group">
			  ...
			  $gadget=mysqli_query($con,"SELECT * FROM products WHERE branchcat='CHEMICAL' && procat='Gadgets' && visibility='1' ORDER BY sno DESC LIMIT 12");
			  ...
			  {
			  while($gadgetd=mysqli_fetch_array($gadget))
			  {
				  ?>
				<div class="grid_1_of_4 images_1_of_4">
		...
		<div class="content_top">
	      ...
	      <div class="section group">
			  ...
			  $arts=mysqli_query($con,"SELECT * FROM products WHERE branchcat='CHEMICAL' && procat='Arts' && visibility='1' ORDER BY sno DESC LIMIT 12");
		...
		<div class="content_top">
	      ...
	      <div class="section group">
			  ...
			  $others=mysqli_query($con,"SELECT * FROM products WHERE branchcat='CHEMICAL' && procat='Others' && visibility='1' ORDER BY sno DESC LIMIT 12");
