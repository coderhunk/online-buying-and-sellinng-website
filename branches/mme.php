    ...
    <div class="content">
    	<div class="content_top">
	      ...
	      <div class="section group">
			  ...
			  $books=mysqli_query($con,"SELECT * FROM products WHERE branchcat='MME' && procat='Books' && visibility='1' ORDER BY sno DESC LIMIT 12");
		...
		<div class="content_top">
	      ...
	      <div class="section group">
			  ...
			  $gadget=mysqli_query($con,"SELECT * FROM products WHERE branchcat='MME' && procat='Gadgets' && visibility='1' ORDER BY sno DESC LIMIT 12");
		...
		<div class="content_top">
	      ...
	      <div class="section group">
			  ...
			  $arts=mysqli_query($con,"SELECT * FROM products WHERE branchcat='MME' && procat='Arts' && visibility='1' ORDER BY sno DESC LIMIT 12");
		...
		<div class="content_top">
	      ...
	      <div class="section group">
			  ...
			  $others=mysqli_query($con,"SELECT * FROM products WHERE branchcat='MME' && procat='Others' && visibility='1' ORDER BY sno DESC LIMIT 12");
